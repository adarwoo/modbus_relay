...
| 30015          | 0x000E    | R      | Diagnostic code | Diagnostic code of the EStop condition<br>The content value depends on the EStop root cause:<ul><li><b>normal</b><br/>0</li><li><b>relay</b><br/>Holds the faulty relay index + 1, so it will not be zero.</li><li><b>modbus</b><br/>The timeout in seconds</li><li><b>voltage</b><br/>0xFFFF is the voltage type is incorrect, else the triggering voltage in 1/10V</li><li><b>external</b><br/>Contains the [EStop control](#estop-control) value</li></ul><br/><b>Note:</b> This register and the root cause are cleared when reading it unless an active EStop is in progress |
